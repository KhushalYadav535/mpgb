  ...
  return (
    <section className="bg-white pb-24 lg:pb-32">
      <div className="container-px">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-ink-800 via-ink-900 to-ink-950 px-8 py-16 text-center shadow-lift sm:px-16 lg:py-20">
          ...
          <div className="pointer-events-none absolute -right-20 bottom-0 h-64 w-64 rounded-full bg-ink-400/20 blur-3xl" />
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
              ...
              <a href="tel:18002001976" className="btn-ghost">
                <Phone className="h-4 w-4" /> 1800-200-1976
              </a>
            </div>
          </div>
        </div>
